					...
					<li class="dropdown" id="header_inbox_bar">
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								...
								<span class="photo"><img src="<%=basePath  %>/media/image/avatar2.jpg" alt="" /></span>
								<span class="subject">
							...
							<li>
								<a href="inbox.html?a=view">
								<span class="photo"><img src="<%=basePath  %>/media/image/avatar3.jpg" alt="" /></span>
								<span class="subject">
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="start active ">
					<a href="index.html">
					<i class="icon-home"></i> 
					<span class="title">仪表盘(Dashboard)</span>
				...
				<li class="">
					<a href="javascript:;">
					<i class="icon-cogs"></i> 
					<span class="title">布局(Layouts)</span>
					<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li >
							<a href="layout_horizontal_sidebar_menu.html">
							水平和侧边导航栏(Horzontal & Sidebar Menu)</a>
						</li>
						<li >
							<a href="layout_horizontal_menu1.html">
							水平菜单1(Horzontal Menu 1)</a>
						</li>
						<li >
							<a href="layout_horizontal_menu2.html">
							水平菜单2(Horzontal Menu 2)</a>
						</li>
						<li >
												...
												<div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
													<div class="row-fluid">
														<div class="span6 user-info">
															<img alt="" src="<%=basePath %>/media/image/avatar.png" />
															<div class="details">
																<div>
							...
							<div class="portlet">
								...
								<div class="portlet-body" id="chats">
									<div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
										<ul class="chats">
											<li class="in">
												<img class="avatar" alt="" src="<%=basePath %>/media/image/avatar1.jpg" />
												<div class="message">
													<span class="arrow"></span>
											...
											<li class="out">
												<img class="avatar" alt="" src="<%=basePath %>/media/image/avatar2.jpg" />
												<div class="message">
													<span class="arrow"></span>
											...
											<li class="out">
												<img class="avatar" alt="" src="<%=basePath %>/media/image/avatar3.jpg" />
												<div class="message">
													<span class="arrow"></span>
